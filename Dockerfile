...
COPY builder/convert_original_sd_to_diffuser.py /convert_original_sd_to_diffuser.py
RUN wget https://civitai.com/api/download/models/143906 --content-disposition
# https://raw.githubusercontent.com/huggingface/diffusers/v0.21.0/scripts/convert_original_stable_diffusion_to_diffusers.py
